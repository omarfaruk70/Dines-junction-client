...
const RegistrationPage = () => {
  ...
  const handleRegister = (event) => {
    ...
    createUser(email, password)
      .then(() => {
        axios.post("/savealluserinfo/loggedinuser", userInfo).then((res) => {
    ...
    <div>
      ...
      <div className="lg:max-w-7xl h-[650px] py-5 flex lg:flex-row-reverse mx-auto justify-around">
        <div className="border rounded-lg md:max-w-7xl">
          ...
          <form onSubmit={handleRegister} className="mt-8 mb-2  sm:w-96  px-5">
        ...
        <div className="lg:max-w-6xl hidden lg:block">
          <iframe
            src="https://lottie.host/embed/3d10a09b-b359-433f-ad81-88d7548d64cb/PD3fM8D3eV.json"
            className="lg:h-[500px] lg:w-[550px]"
          ></iframe>
        </div>
      </div>
    </div>
